...
let ListsController = class ListsController {
    ...
    create(request, createListDto) {
        return this.listsService.create(request.user.sub, createListDto);
    }
    update(id, request, updateListDto) {
        return this.listsService.update(id, request.user.sub, updateListDto);
    }
    async remove(id, request) {
        await this.listsService.remove(id, request.user.sub);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object, update_list_dto_1.UpdateListDto]),
    __metadata("design:returntype", void 0)
...
exports.ListsController = ListsController = __decorate([
    ...
    (0, common_1.Controller)('api/lists'),
